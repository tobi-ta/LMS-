var OneTrustStub = (t => {
    ...
    var i, a, o, r, n, p = new function() {
        ...
        s = ((b = i = i || {})[b.Days = 1] = "Days", b[b.Weeks = 7] = "Weeks", b[b.Months = 30] = "Months", b[b.Years = 365] = "Years", (b = n = n || {}).GDPR = "GDPR", b.CCPA = "CCPA", b.IAB2 = "IAB2", b.IAB2V2 = "IAB2V2", b.GENERIC = "GENERIC", b.LGPD = "LGPD", b.GENERIC_PROMPT = "GENERIC_PROMPT", b.CPRA = "CPRA", b.CDPA = "CDPA", b.DELAWARE = "DELAWARE", b.IOWA = "IOWA", b.NEBRASKA = "NEBRASKA", b.USNATIONAL = "USNATIONAL", b.CUSTOM = "CUSTOM", b.FLORIDA = "FLORIDA", b.COLORADO = "COLORADO", b.CONNECTICUT = "CTDPA", b.MONTANA = "MONTANA", b.TEXAS = "TEXAS", b.OREGON = "OREGON", b.TENNESSEE = "TENNESSEE", b.NEWJERSEY = "NEWJERSEY", b.NEWHAMPSHIRE = "NEWHAMPSHIRE", b.UCPA = "UCPA", b.VIRGINIA = "VIRGINIA", n.CPRA, n.CDPA, n.COLORADO, n.OREGON, n.CONNECTICUT, n.FLORIDA, n.MONTANA, n.TEXAS, n.DELAWARE, n.IOWA, n.NEBRASKA, n.TENNESSEE, n.NEWJERSEY, n.NEWHAMPSHIRE, n.UCPA, (b = v = v || {}).Name = "OTGPPConsent", b[b.ChunkSize = 4e3] = "ChunkSize", b.ChunkCountParam = "GPPCookiesCount", b.gppSid = "gppSid", (n = a = a || {}).CPRA = "usca", n.CCPA = "usca", n.CDPA = "usva", n.OREGON = "usor", n.USNATIONAL = "usnat", n.COLORADO = "usco", n.FLORIDA = "usfl", n.CTDPA = "usct", n.MONTANA = "usmt", n.TEXAS = "ustx", n.DELAWARE = "usde", n.IOWA = "usia", n.NEBRASKA = "usne", n.TENNESSEE = "ustn", n.NEWJERSEY = "usnj", n.NEWHAMPSHIRE = "usnh", n.UCPA = "usut", n.VIRGINIA = "usva", n.IAB2V2 = "tcfeuv2", (b = o = o || {})[b.CPRA = 8] = "CPRA", b[b.CCPA = 8] = "CCPA", b[b.CDPA = 9] = "CDPA", b[b.OREGON = 15] = "OREGON", b[b.USNATIONAL = 7] = "USNATIONAL", b[b.COLORADO = 10] = "COLORADO", b[b.FLORIDA = 13] = "FLORIDA", b[b.MONTANA = 14] = "MONTANA", b[b.TEXAS = 16] = "TEXAS", b[b.DELAWARE = 17] = "DELAWARE", b[b.IOWA = 18] = "IOWA", b[b.NEBRASKA = 19] = "NEBRASKA", b[b.NEWHAMPSHIRE = 20] = "NEWHAMPSHIRE", b[b.NEWJERSEY = 21] = "NEWJERSEY", b[b.TENNESSEE = 22] = "TENNESSEE", b[b.UCPA = 11] = "UCPA", b[b.VIRGINIA = 9] = "VIRGINIA", b[b.CTDPA = 12] = "CTDPA", b[b.IAB2V2 = 2] = "IAB2V2", "geo"),
        l = "otpreview",
        c = (v.Name, "LOCAL"),
        d = "PRODUCTION",
        h = (0, i.Days, i.Weeks, i.Months, i.Years, m.prototype.camelize = function(t) {
            return (t = t.replace("--", "")).split("-").map(function(t, e) {
                var i = t ? t[0].toUpperCase() + t.slice(1) : "";
                return 0 === e ? t : i
            }).join("")
        }, m.prototype.strToObj = function(t) {
    ...
    var f = new function() {
        ...
        A = (y.initCSPTrustedType = function(t) {
        ...
        }, y.createScriptURL = function(t) {
            return y.isCspTrustedType() ? window.OtTrustedType.TrustedTypePolicy.createScriptURL(t) : t
        }, y.checkAndAssignCspTrustedTypeEnabled = function(t) {
    ...
    function y() {}
    S.prototype.initConsentSDK = function() {
    ...
    }, S.prototype.captureNonce = function() {
        this.nonce = p.stubScriptElement.nonce || p.stubScriptElement.getAttribute("nonce") || null
    }, S.prototype.captureShopify = function() {
        this.isShopify = p.stubScriptElement.hasAttribute("data-shopify-consent-mapping")
    }, S.prototype.fetchBannerSDKDependency = function() {
        this.setDomainDataFileURL(), this.crossOrigin = p.stubScriptElement.getAttribute("crossorigin") || null, this.previewMode = "true" === p.stubScriptElement.getAttribute("data-preview-mode"), this.otFetch(p.bannerDataParentURL, this.getLocation.bind(this), !1, null, null, !0)
    }, S.prototype.setDomainIfBulkDomainEnabled = function(t) {
        var e = t && t.TenantFeatures,
            i = window.location.hostname,
            n = t.Domain,
            a = t.BulkDomainCheckUrl;
        e && e.CookieV2BulkDomainManagement && i !== n && t.ScriptType === d && ((e = window.sessionStorage) && e.getItem("bulkDomainMgmtEnabled") ? this.handleBulkDomainMgmt({
        ...
        if (this.setDomainIfBulkDomainEnabled(t), this.updateVersion(t), this.subDomainEnabled = t.SubDomainEnabled || !1, this.domainHashValue = t.DomainHashValue || "", this.scriptType = t.ScriptType || "", this.ensureHtmlGroupDataInitialised(), (t.TenantFeatures && t.TenantFeatures.CookieV2CSP || t.CookieV2CSPEnabled) && this.nonce && (this.setAttributePolyfillIsActive = !0, (new h).implementThePolyfill()), A.checkAndAssignCspTrustedTypeEnabled(t) && A.initCSPTrustedType(p.storageBaseURL), !t.RuleSet[0].Type) return this.iabTypeAdded = !1, window.__tcfapi = this.executeTcfApi, this.intializeIabStub(), this.addBannerSDKScript(t);
        var e, i = window;
        i.OneTrust && i.OneTrust.geolocationResponse ? (i = i.OneTrust.geolocationResponse, this.setGeoLocation(i.countryCode, i.stateCode, i.stateName), this.addBannerSDKScript(t)) : (i = this.readCookieParam(p.optanonCookieName, p.geolocationCookiesParam)) || t.SkipGeolocation ? (e = i.split(";")[0], i = i.split(";")[1], this.setGeoLocation(e, i), this.addBannerSDKScript(t)) : this.getGeoLocation(t)
    }, S.prototype.handleBulkDomainMgmt = function(t, e) {
    ...
    }, S.prototype.getGeolocationURL = function(t) {
        t.TenantFeatures;
    ...
    }, S.prototype.geoLocationJsonCallback = function(t, e) {
        e && this.setGeoLocation(e.country, e.state, e.stateName), this.addBannerSDKScript(t)
    }, S.prototype.getGeoLocation = function(t) {
        var e = this.getGeolocationURL(t);
        this.otFetch(e, this.geoLocationJsonCallback.bind(this, t), !0)
    }, S.prototype.setOTDataLayer = function() {
        var t = "data-dLayer-ignore",
            e = p.stubScriptElement.hasAttribute(t),
            t = p.stubScriptElement.getAttribute(t);
        this.otDataLayer = {
            ignore: e && "true" === t || e && "" === t,
            name: this.getStubAttrOrQueryParam("data-dLayer-name") || "dataLayer"
        }
    }, S.prototype.setGeoLocation = function(t, e, i) {
        p.userLocation = {
            country: t,
            state: e = void 0 === e ? "" : e,
            stateName: i = void 0 === i ? "" : i
        }
    }, S.prototype.otFetch = function(t, i, e, n, a, o) {
        void 0 === e && (e = !1), void 0 === n && (n = null), void 0 === o && (o = !1);
        var s = window.sessionStorage && window.sessionStorage.getItem("otPreviewData");
        if (new RegExp("^file://", "i").test(t)) this.otFetchOfflineFile(t, i);
        else if (0 <= t.indexOf("/consent/") && this.previewMode && s) {
            s = JSON.parse(s).domainJson;
            i(s)
        } else {
            p.mobileOnlineURL.push(t);
            var r = new XMLHttpRequest,
                u = this;
            if (r.onload = function(t) {
                    var e;
                    this && this.responseText ? e = this.responseText : t && t.target && (e = t.target.responseText), o && this && this.getResponseHeader && (t = this.getResponseHeader("X-OneTrust-IsBot"), u.isBotHeaderDomain = !!t && "true" === t.toLowerCase()), a ? i(JSON.parse(e), a) : i(JSON.parse(e))
                }, r.onerror = function() {
                    i()
                }, r.open("GET", t), r.withCredentials = !1, e && r.setRequestHeader("accept", "application/json"), n)
                for (var l in n) r.setRequestHeader(l, n[l]);
            r.send()
        }
    }, S.prototype.otFetchOfflineFile = function(t, e) {
        var i = (t = t.replace(".json", ".js")).split("/"),
            n = i[i.length - 1].split(".js")[0];
        this.jsonp(t, function() {
            e(window[n])
        })
    }, S.prototype.jsonp = function(t, e, i, n) {
        void 0 === i && (i = !1), void 0 === n && (n = "");
        var a = document.createElement("script"),
            o = A.createScriptURL(t);
        a.setAttribute("src", o), this.nonce && a.setAttribute("nonce", this.nonce), a.async = !0, a.type = "text/javascript", i && n && (a.integrity = n), this.crossOrigin && a.setAttribute("crossorigin", this.crossOrigin), document.getElementsByTagName("head")[0].appendChild(a), new RegExp("^file://", "i").test(t) || p.mobileOnlineURL.push(t), e && (a.onload = a.onerror = function() {
            e()
        })
    }, S.prototype.getRegionSet = function(t) {
    ...
    }, S.prototype.validateIABGDPRApplied = function() {
    ...
    }, S.prototype.readCookieParam = function(t, e) {
        ...
        return ""
    }, S.prototype.getCookieNameSuffix = function() {
        return (this.scriptType === d || this.scriptType === c) && this.subDomainEnabled && this.domainHashValue ? "_" + this.domainHashValue : ""
        ...
        return null
    }, S.prototype.updateGtmMacros = function() {
    ...
    }, S.prototype.deserialiseStringToArray = function(t) {
        return t ? t.split(",") : []
    }, S.prototype.endsWith = function(t, e) {
        return -1 !== t.indexOf(e, t.length - e.length)
    }, S.prototype.serialiseArrayToString = function(t) {
        return t.toString()
    }, S.prototype.getStubAttrOrQueryParam = function(t) {
        var e = p.stubScriptElement,
            i = e && e.getAttribute(t);
        return i || (i = e && e.getAttribute("src"), this.getStubQueryParam(i, t))
    }, S.prototype.getStubQueryParam = function(t, e) {
        return !t || (t = t.split("?")).length < 2 ? null : new URLSearchParams(t[1]).get(e)
    }, S.prototype.setStubScriptElement = function() {
    ...
    }, S.prototype.setDomainDataFileURL = function() {
    ...
    }, S.prototype.initCustomEventPolyfill = function() {
    ...
    }, S.prototype.setGeoParam = function(t) {
        var e;
        t && ((e = window).OneTrust || (e.OneTrust = {}), t = t.split(","), e.OneTrust.geolocationResponse = {
            countryCode: t[0],
            stateCode: t[1]
        })
    }, S.prototype.updateVersion = function(t) {
        "debug" !== this.buildType && "cybuild" !== this.buildType || (t.Version = "202604.2.0")
    };
    var b = S;

    function S() {
        var r = this;
        this.iabType = null, this.iabTypeAdded = !0, this.crossOrigin = null, this.isAmp = !1, this.domainId = "", this.isReset = !1, this.isPreview = !1, this.geoFromUrl = "", this.nonce = "", this.setAttributePolyfillIsActive = !1, this.storageBaseURL = "", this.charset = null, this.isShopify = !1, this.isBotHeaderDomain = !1, this.subDomainEnabled = !1, this.domainHashValue = "", this.scriptType = "", this.buildType = "undefined", this.addBannerSDKScript = function(s) {
            return e(r, void 0, void 0, function() {
                var e, i, n, a, o;
                return u(this, function(t) {
                    switch (t.label) {
                        case 0:
                            return ((e = this.getRegionSet(s)).GCEnable || (this.updateGtmMacros(), this.gtmUpdated = !0), this.iabTypeAdded && ("IAB2" !== e.Type && "IAB2V2" !== e.Type || (this.iabType = e.Type, this.intializeIabStub()), "IAB2" !== e.Type) && "IAB2V2" !== e.Type && this.removeTcf(), e.IsGPPEnabled ? f.init() : f.removeGppApi(), i = p.stubScriptElement.cloneNode(!0), n = "", n = s.UseSDKRefactor ? (p.isMigratedURL && (i.src = p.storageBaseURL + "/scripttemplates/new/scripttemplates/" + p.stubFileName + ".js"), p.storageBaseURL + "/scripttemplates/new/scripttemplates/" + s.Version + "/" + p.bannerScriptName) : "5.11.0" === s.Version ? (p.isMigratedURL && (i.src = p.storageBaseURL + "/scripttemplates/old/scripttemplates/" + p.stubFileName + ".js"), p.storageBaseURL + "/scripttemplates/old/scripttemplates/5.11.0/" + p.bannerScriptName) : (p.isMigratedURL && (i.src = p.storageBaseURL + "/scripttemplates/" + p.stubFileName + ".js"), p.storageBaseURL + "/scripttemplates/" + s.Version + "/" + p.bannerScriptName), ["charset", "data-language", "data-document-language", "data-domain-script", "crossorigin", "data-ignore-ga"].forEach(function(t) {
                                p.stubScriptElement.getAttribute(t) && i.setAttribute(t, p.stubScriptElement.getAttribute(t))
                            }), this.charset = p.stubScriptElement.getAttribute("charset"), this.isAmp = !!p.stubScriptElement.getAttribute("amp"), p.stubScriptElement.getAttribute("integrity")) ? (o = s.CDNLocation + "/scripttemplates/" + s.Version + "/sri-hashes.json", [4, this.fetchSriHash(o)]) : [3, 2];
                        case 1:
                            return a = t.sent(), [3, 3];
                        case 2:
                            a = null, t.label = 3;
            ...
            g(n, "display: none;", !0), n.name = t, n.setAttribute("title", e + " Locator"), i.document.body.appendChild(n)
    ...
    var v = new b;
    return t.OtSDKStub = b, t.otSdkStub = v, Object.defineProperty(t, "__esModule", {
        value: !0
    }), t
})({});