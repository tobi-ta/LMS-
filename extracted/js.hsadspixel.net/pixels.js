! function() {
    ...
    function o(e, o, i) {
        if (i && i.hubletPostfixLocation && "domain" === i.hubletPostfixLocation) return o;
        o === n.APP_API && (o = n.APP);
        return `${o}${t(e,i)}`
    }
    ...
    function s(e, n) {
        return n && n.hubletPostfixLocation && "domain" === n.hubletPostfixLocation ? t(e, n) : ""
    }
    ...
    function A(e) {
        ! function(n, t, o) {
            ...
            var i = n[o] = n[o] || [];
            i.methods = ["page", "track", "identify", "instances", "debug", "on", "off", "once", "ready", "alias", "group", "enableCookie", "disableCookie", "holdConsent", "revokeConsent", "grantConsent"], i.setAndDefer = function(e, n) {
                e[n] = function() {
            ...
            i.instance = function(e) {
                for (var n = i._i[e] || [], t = 0; t < i.methods.length; t++) i.setAndDefer(n, i.methods[t]);
                return n
            }, i.load = function(e, n) {
                var t = "https://analytics.tiktok.com/i18n/pixel/events.js";
                n && n.partner;
                i._i = i._i || {}, i._i[e] = [], i._i[e]._u = t, i._t = i._t || {}, i._t[e] = +new Date, i._o = i._o || {}, i._o[e] = n || {};
                (n = document.createElement("script")).type = "text/javascript", n.async = !0, n.src = t + "?sdkid=" + e + "&lib=" + o;
    ...
    function K() {
        ...
        n && window.history && window.history.replaceState && window.history.replaceState(null, "", e.toString())
    }
    const R = e => e.split("_").map((e => e.charAt(0).toUpperCase() + e.slice(1).toLowerCase())).join(""),
        T = function() {
            K();
            const e = _();
            let n, t = null,
            ...
            if (!(window.disabledHsPopups && window.disabledHsPopups.indexOf("ADS") > -1)) {
                ...
                window._hsp.push(["addPrivacyConsentListener", function(n) {
                    n.categories.advertisement ? t ? S(t, o) : j({
                ...
                window.addEventListener("hs-form-event:on-submission:success", (e => {
                    ...
                    r({
                        conversionId: n.getConversionId(),
                        formGuid: n.getFormId()
                    })
                }));
                window.addEventListener("message", (e => {
                    e.data && "hsFormCallback" === e.data.type && "onFormSubmitted" === e.data.eventName && r(e.data.data)
                }), !1)
            }
...
//# sourceMappingURL=//static.hsappstatic.net/adsscriptloaderstatic/static-1.3055/bundles/pixels-release.js.map