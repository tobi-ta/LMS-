window.hjSiteSettings = window.hjSiteSettings || {
    ...
    "polls": [{
        ...
        "content": {
            ...
            "questions": [{
                "next": "thankYou",
                "required": true,
                "text": "We're sorry to see you go! May we ask why you're not interested in booking a demo?",
                "type": "single-open-ended-multiple-line",
                "uuid": "4acd5c9f-b55a-4103-9e5d-7c6de48d4d28"
            }],
            "thankyou": "Thank you for answering the question. Your feedback is highly appreciated!"
        },
        ...
        "targeting": [{
            ...
            "negate": false,
            "pattern": "https://www.thinkific.com/get-started/plus-customer-training-platform/",
            "name": null,
            "rule_type": null
        }, {
            "component": "url",
            "match_operation": "simple",
            "negate": false,
            "pattern": "https://www.thinkific.com/get-started/plus-revenue-generation-platform/",
            "name": null,
            "rule_type": null
        }, {
            "component": "device",
            ...
            "match_operation": "simple",
            "negate": false,
            "pattern": "https://www.thinkific.com/get-started/plus-vs-legacy-lms/",
            "name": null,
            "rule_type": null
        }, {
            "component": "url",
            "match_operation": "simple",
            "negate": false,
            "pattern": "https://www.thinkific.com/get-started/plus-training-platform/",
            "name": null,
            "rule_type": null
        }, {
            "component": "url",
            "match_operation": "simple",
            "negate": false,
            "pattern": "https://www.thinkific.com/get-started/thinkific-plus-vs-absorb-lms/",
            "name": null,
            "rule_type": null
        }, {
            "component": "device",
            ...
            "match_operation": "simple",
            "negate": false,
            "pattern": "https://www.thinkific.com/get-started/thinkific-plus-vs-docebo/",
            "name": null,
            "rule_type": null
        }, {
            "component": "url",
            "match_operation": "simple",
            "negate": false,
            "pattern": "https://www.thinkific.com/get-started/plus-lms-platform-market-leaders/",
            "name": null,
            "rule_type": null
        }, {
            "component": "url",
            "match_operation": "simple",
            "negate": false,
            "pattern": "https://www.thinkific.com/get-started/thinkific-plus-vs-learnupon/",
            "name": null,
            "rule_type": null
        }, {
            "component": "device",
            ...
            "match_operation": "simple",
            "negate": false,
            "pattern": "https://www.thinkific.com/get-started/thinkific-plus-vs-litmos/",
            "name": null,
            "rule_type": null
        }, {
            "component": "url",
            "match_operation": "simple",
            "negate": false,
            "pattern": "https://www.thinkific.com/get-started/plus-scorm-platform/",
            "name": null,
            "rule_type": null
        }, {
            "component": "url",
            "match_operation": "simple",
            "negate": false,
            "pattern": "https://www.thinkific.com/get-started/thinkific-plus-vs-skilljar/",
            "name": null,
            "rule_type": null
        }],
        "uuid": "d1a39a41-b4f6-4866-8c0a-ccf393b432c0",
        "invite": {
        ...
        "content": {
            ...
            "questions": [{
                "next": "thankYou",
                "required": true,
                "text": "We're sorry to see you go! May we ask why you're not interested in seeing a free on-demand demo?",
                "type": "single-open-ended-multiple-line",
                "uuid": "3dd4136b-e879-4f08-a8c7-6bff85d6746d"
            }],
            "thankyou": "Thank you for answering the question. Your feedback is highly appreciated!"
        },
        "connect_visit_data": "always",
        ...
        "targeting": [{
            ...
            "match_operation": "simple",
            "negate": false,
            "pattern": "https://www.thinkific.com/get-started/plus-lms/",
            "name": null,
            "rule_type": null
        }, {
            "component": "url",
            "match_operation": "simple",
            "negate": false,
            "pattern": "https://www.thinkific.com/get-started/thinkific-plus-vs-absorb-lms-demo/",
            "name": null,
            "rule_type": null
        }, {
            "component": "url",
            "match_operation": "simple",
            "negate": false,
            "pattern": "https://www.thinkific.com/get-started/thinkific-plus-vs-docebo-demo/",
            "name": null,
            "rule_type": null
        }, {
            "component": "url",
            "match_operation": "simple",
            "negate": false,
            "pattern": "https://www.thinkific.com/get-started/thinkific-plus-vs-learnupon-demo/",
            "name": null,
            "rule_type": null
        }, {
            "component": "url",
            "match_operation": "simple",
            "negate": false,
            "pattern": "https://www.thinkific.com/get-started/thinkific-plus-vs-litmos-demo/",
            "name": null,
            "rule_type": null
        }, {
            "component": "url",
            "match_operation": "simple",
            "negate": false,
            "pattern": "https://www.thinkific.com/get-started/thinkific-plus-vs-skilljar-demo/",
            "name": null,
            "rule_type": null
        }, {
            "component": "url",
            "match_operation": "simple",
            "negate": false,
            "pattern": "https://www.thinkific.com/get-started/plus-customer-education/",
            "name": null,
            "rule_type": null
        }, {
            "component": "device",
            ...
            "match_operation": "simple",
            "negate": false,
            "pattern": "https://www.thinkific.com/get-started/plus-training-demo/",
            "name": null,
            "rule_type": null
        }, {
            "component": "url",
            "match_operation": "simple",
            "negate": false,
            "pattern": "https://www.thinkific.com/get-started/plus-lms-market-leaders-demo/",
            "name": null,
            "rule_type": null
        }, {
            "component": "url",
            "match_operation": "simple",
            "negate": false,
            "pattern": "https://www.thinkific.com/get-started/plus-scorm-demo/",
            "name": null,
            "rule_type": null
        }, {
            "component": "url",
            "match_operation": "simple",
            "negate": false,
            "pattern": "https://www.thinkific.com/get-started/plus-revenue-generation/",
            "name": null,
            "rule_type": null
        }, {
            "component": "url",
            "match_operation": "simple",
            "negate": false,
            "pattern": "https://www.thinkific.com/get-started/plus-vs-legacy-lms-demo/",
            "name": null,
            "rule_type": null
        }],
        "uuid": "e2fbab41-1c50-4530-8961-db9a03af6fad",
        "invite": {
            "title": "Your feedback is important to us!",
            "description": "Tell us what you think about this page by taking our quick Survey.",
            "button": "Yes, I will give feedback",
    ...
    "cs_tag_name": null,
    "account_id": 84615,
    "account_signature": "6badbad1f8d0fc72bbf398e2d5f6dad9bb0d89c4ac6e6ee630193df467476bf7"
};
...
! function() {
    ...
    function C() {
        ...
        if (w && window._uxa) window._uxa.push(["start:hotjar", hjSiteSettings]), window.hj.scriptLoaded = !0;
            ...
            }, window.hjBootstrap(e, t, n), window.hjBootstrap.revision = "1db30dd";
            var c = window.document,
                l = c.head || c.getElementsByTagName("head")[0];
            hj.scriptDomain = e;
            var d = c.createElement("script");
            d.async = !0, d.src = hj.scriptDomain + t, d.charset = "utf-8", l.appendChild(d)
        }, window.hjBootstrap("https://script.hotjar.com/", "modules.6a0f3932cb1341a35c18.js", "134665")
    }
    window.hjLazyModules = window.hjLazyModules || {
        SURVEY_V2: {
            js: "survey-v2.bd222e2ae8e4365e2dea.js"
        },
        SURVEY_BOOTSTRAPPER: {
        ...
        SURVEY_INVITATION: {
            js: "survey-invitation.fb0664c0492733616d9f.js"
        },
        NOTIFICATION: {
        ...
        USER_TEST: {
            js: "user-test.3117c8128b29c19197b7.js"
        }
    };
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
            n = (new Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "2fe374e2-28bc-5b1d-a642-1b0d480c6c8f")
    } catch (e) {}
}();
//# debugId=2fe374e2-28bc-5b1d-a642-1b0d480c6c8f