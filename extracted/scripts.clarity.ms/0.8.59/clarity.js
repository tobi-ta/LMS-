/* clarity-js v0.8.59: https://github.com/microsoft/clarity (License: MIT) */ ! function() {
    "use strict";
    var t = Object.freeze({
            __proto__: null,
            get add() {
    ...
    function L(t, e) {
        du() && t && "string" == typeof t && t.length < 255 && (X = e && "string" == typeof e && e.length < 255 ? {
            key: t,
            value: e
        } : {
            value: t
    ...
    function V(t, e, n) {
        return window.setTimeout(Bo(t), e, n)
    }
    ...
    function Q() {
        ...
        z = {
            gap: t - K
        }, Bi(25), z.gap < 3e5 ? G = V(Q, J) : cu && (L("clarity", "suspend"), ju(), ["mousemove", "touchstart"].forEach((function(t) {
            return Jo(document, t, fu)
        })), ["resize", "scroll", "pageshow"].forEach((function(t) {
            return Jo(window, t, fu)
        })))
    }
    var $ = Object.freeze({
            __proto__: null,
    ...
    function ht(t, e) {
        if (du() && t && e && "string" == typeof t && t.length < 255) {
        ...
        try {
            for (var t in St) {
                ...
                if ("" == Et[e] || document.querySelector(Et[e])) {
                    ...
                    for (var v in h) {
                        var g = parseInt(v);
                        xt(e, g, dr(h[g]).trim().slice(0, 1e4))
                    }
                }
            }
            wt.size > 0 && Bi(40)
        } catch (t) {
            Oi(5, 1, t ? t.name : null)
        }
        var m
    }
    ...
    function Kt(t, e, n) {
        c.fraud && null !== t && n && n.length >= 5 && (Vt = {
            ...
            target: e,
            checksum: p(n, 28)
        }, Bt.indexOf(Vt.checksum) < 0 && (Bt.push(Vt.checksum), wi(41)))
    }
        ...
        if (t && t.offsetParent)
            do {
                var n = t.offsetParent,
                    a = null === n ? or(t.ownerDocument) : null;
    ...
    function be(t) {
        "Enter" === t.key && !t.repeat && me.length > 0 && (B(ge), we(27))
    }
    ...
    function Ie(t) {
        switch (t.event) {
            ...
            case 19:
                ...
                }(n, t) && Oe.pop(), Oe.push(t), B(Ee), Ee = V(Ce, 500, t.event);
                break;
            default:
                Oe.push(t), Ce(t.event)
        }
    }
    ...
    function Ae() {
        ...
        }, Ye ? (B(Re), Re = V(Xe, 500, 11)) : (jr(11), Ye = !0)
    }
    ...
    function Ue(t) {
        ...
        if (a) {
            ...
            if (null === t && 0 === i && 0 === o || null === i || null === o) return We = h, void(He = p);
            var m = ze.length,
                y = m > 1 ? ze[m - 2] : null;
            y && function(t, e) {
                var n = t.data.x - e.data.x,
            ...
            }(y, g) && ze.pop(), ze.push(g), B(qe), qe = V(Be, 500, 10)
        }
    }
    var Fe = Pe(Ue, 25);
    ...
    function Ke() {
        ...
        if (We) {
            var n = Yr(We, null);
            ro(31, null === (t = null == n ? void 0 : n.hash) || void 0 === t ? void 0 : t.join("."))
        }
        if (He) {
            var a = Yr(He, null);
            ro(32, null === (e = null == a ? void 0 : a.hash) || void 0 === e ? void 0 : e.join("."))
        }
    }
    var Je = null,
        Ge = null,
    ...
    function Qe(t) {
        ...
        if (null !== e && !(null === e.anchorNode && null === e.focusNode || e.anchorNode === e.focusNode && e.anchorOffset === e.focusOffset)) {
            var n = Je.start ? Je.start : null;
            null !== Ge && null !== Je.start && n !== e.anchorNode && (B(Ze), $e(21)), Je = {
                start: e.anchorNode,
                startOffset: e.anchorOffset,
                end: e.focusNode,
                endOffset: e.focusOffset
            }, Ge = e, B(Ze), Ze = V($e, 500, 21)
        }
    }
    ...
    function vn(t) {
        t && t.persisted && (Yu(), Oi(11, 0))
    }

    function gn(t) {
        ! function(t) {
            var e = or(t);
            Jo(e ? e.contentWindow : t === document ? window : t, "scroll", Fe, !0)
        }(t), t.nodeType === Node.DOCUMENT_NODE && (function(t) {
            Jo(t, "click", oe.bind(this, 9, t), !0), Jo(t, "contextmenu", oe.bind(this, 48, t), !0)
        }(t), function(t) {
            Jo(t, "cut", pe.bind(this, 0), !0), Jo(t, "copy", pe.bind(this, 1), !0), Jo(t, "paste", pe.bind(this, 2), !0)
        }(t), function(t) {
            Jo(t, "mousedown", Ne.bind(this, 13, t), !0), Jo(t, "mouseup", Ne.bind(this, 14, t), !0), Jo(t, "mousemove", Ne.bind(this, 12, t), !0), Jo(t, "wheel", Ne.bind(this, 15, t), !0), Jo(t, "dblclick", Ne.bind(this, 16, t), !0), Jo(t, "touchstart", xe.bind(this, 17, t), !0), Jo(t, "touchend", xe.bind(this, 18, t), !0), Jo(t, "touchmove", xe.bind(this, 19, t), !0), Jo(t, "touchcancel", xe.bind(this, 20, t), !0)
        }(t), function(t) {
            Jo(t, "input", ye, !0), Jo(t, "keydown", be, !0)
        }(t), function(t) {
            Jo(t, "selectstart", Qe.bind(this, t), !0), Jo(t, "selectionchange", Qe.bind(this, t), !0)
        }(t), function(t) {
            Jo(t, "change", te, !0)
        }(t), function(t) {
            Jo(t, "submit", on, !0)
    ...
    var mn = Object.freeze({
        ...
        observe: gn,
        start: function() {
            Ar = [], Lr(), fe(), ve(), De(), Se(), Ye = !1, Jo(window, "resize", je), Ae(), Jo(document, "visibilitychange", ln), ln(), Jo(window, "focus", (function() {
                    return hn(1)
                ...
                function() {
                    if (!pn) try {
                        window[s("addEventListener")]("pageshow", Bo(vn), {
                            capture: !1,
                            passive: !0
                        }), pn = !0
                    } catch (t) {}
                }(), ze = [], Ue(), tn(), ee(), un(), Jo(window, "pagehide", cn)
        },
        stop: function() {
            Ar = [], Lr(), fe(), ve(), B(Ee), Oe.length > 0 && Ce(Oe[Oe.length - 1].event), B(ge), Se(), Le(), dn(), fn(), B(qe), Fe.cleanup(), ze = [], We = null, He = null, tn(), B(Ze), ee(), un(), sn()
        }
    });
    ...
    function _n(t) {
        c.lean && c.lite || null == t || (t.clarityOverrides = t.clarityOverrides || {}, t.CSSStyleSheet && t.CSSStyleSheet.prototype && (void 0 === t.clarityOverrides.replace && (t.clarityOverrides.replace = t.CSSStyleSheet.prototype.replace, t.CSSStyleSheet.prototype.replace = function() {
            return du() && Tn.indexOf(this[Sn]) > -1 && In(f(), this[Sn], 1, arguments[0]), t.clarityOverrides.replace.apply(this, arguments)
            ...
            return du() && Tn.indexOf(this[Sn]) > -1 && In(f(), this[Sn], 2, arguments[0]), t.clarityOverrides.replaceSync.apply(this, arguments)
        })))
    }
    ...
    function Nn(t, e) {
        if ((!c.lean || !c.lite) && (-1 === En.indexOf(t) && (En.push(t), t.defaultView && _n(t.defaultView)), e = e || f(), null == t ? void 0 : t.adoptedStyleSheets)) {
            for (var n = [], a = 0, r = t.adoptedStyleSheets; a < r.length; a++) {
                var i = r[a];
                i[Sn] && -1 !== Tn.indexOf(i[Sn]) || (i[Sn] = Ao(), Tn.push(i[Sn]), In(e, i[Sn], 0), In(e, i[Sn], 2, Ca(i))), n.push(i[Sn])
            }
            var o = nr(t, !0);
            kn[o] || (kn[o] = []),
                function(t, e) {
                ...
                }(e, t == document ? -1 : nr(t), 3, n), kn[o] = n, On[o] = e)
        }
    }
    ...
    var Cn = [],
        ...
        jn = null,
        An = null,
        Xn = "clarityAnimationId",
        Ln = "clarityOperationCount",
        zn = 20;
    ...
    function Un(t, e) {
        if (du()) {
            var n = t.effect,
                a = (null == n ? void 0 : n.target) ? nr(n.target) : null;
            if (null !== a && n.getKeyframes && n.getTiming) {
                if (!t[Xn]) {
                    t[Xn] = Ao(), t[Ln] = 0;
                    var r = n.getKeyframes(),
                        i = n.getTiming();
                    Hn(f(), t[Xn], 0, JSON.stringify(r), JSON.stringify(i), a)
                }
                if (t[Ln]++ < zn) {
                    var o = null;
                    switch (e) {
    ...
    function Kn(t) {
        Bn.has(t) || (Bn.add(t), Vn.push(t), Ci(Gn.bind(this, 51)))
    }
            ...
            return ot(this, (function(z) {
                switch (z.label) {
                    case 0:
                        ...
                        return [3, 13];
                    case 1:
                        return i = Fn, r.push(i.width), r.push(i.height), D(t, i.width, i.height), di(r), [3, 13];
                    case 2:
                        for (o = 0, u = Sr; o < u.length; o++) s = u[o], (r = [s.time, 7]).push(s.data.id), r.push(s.data.interaction), r.push(s.data.visibility), r.push(s.data.name), di(r, !1);
                        return Pr(), [3, 13];
                    case 3:
                        for (l = 0, d = wn; l < d.length; l++) m = d[l], (r = [m.time, m.event]).push(m.data.id), r.push(m.data.operation), r.push(m.data.newIds), di(r);
                        for (h = 0, p = bn; h < p.length; h++) m = p[h], (r = [m.time, m.event]).push(m.data.id), r.push(m.data.operation), r.push(m.data.cssRules), di(r, !1);
                        return xn(), [3, 13];
                    case 4:
                        for (v = 0, g = Cn; v < g.length; v++) m = g[v], (r = [m.time, m.event]).push(m.data.id), r.push(m.data.operation), r.push(m.data.keyFrames), r.push(m.data.timing), r.push(m.data.timeline), r.push(m.data.targetId), di(r);
                        return Wn(), [3, 13];
                    case 5:
                        if (2 === Pi(e)) return [3, 13];
                        if (!((y = mr()).length > 0)) return [3, 11];
                        b = 0, w = y, z.label = 6;
                    case 6:
                        return b < w.length ? (k = w[b], 0 !== (O = Pi(e)) ? [3, 8] : [4, ji(e)]) : [3, 10];
                    case 7:
                        O = z.sent(), z.label = 8;
                    case 8:
                        if (2 === O) return [3, 10];
                        for (E = k.data, T = k.metadata.active, _ = k.metadata.suspend, M = k.metadata.privacy, N = function(t) {
                            ...
                            if (E[C = I[x]] || "" === E[C]) switch (C) {
                                case "tag":
                                    R = Zn(k), Y = N ? -1 : 1, r.push(k.id * Y), k.parent && T && (r.push(k.parent), k.previous && r.push(k.previous)), r.push(_ ? "*M" : E[C]), R && 2 === R.length && r.push("".concat("#").concat(Qn(R[0]), ".").concat(Qn(R[1])));
                                    break;
                                case "attributes":
                                    for (j in E[C]) void 0 !== E[C][j] && r.push($n(j, E[C][j], M, E.tag));
                                    break;
                                case "value":
                    ...
                    case 9:
                        return b++, [3, 6];
                    case 10:
                        6 === t && P(a), di(yn(r), !c.lean), z.label = 11;
                    case 11:
                        return [3, 13];
                    case 12:
                        for (A = 0, X = Vn; A < X.length; A++) L = X[A], di([a, 51, L]);
                        return Jn(), [3, 13];
                    case 13:
                        return [2]
                }
    ...
    function ea() {
        ...
        null !== Fn && c === Fn.width && v === Fn.height || null === c || null === v || (Fn = {
            width: c,
            height: v
        }, Gn(8))
    }
    ...
    var aa = new Set,
        ...
        la = {},
        da = new WeakMap,
        fa = ["data-google-query-id", "data-load-complete", "data-google-container-id"];

    function ha() {
        aa = new Set, oa = [], ua = null, sa = 0, la = {}, da = new WeakMap, Sa(window)
    }
    ...
    function va(t, e, n, a) {
        return it(this, void 0, void 0, (function() {
            ...
            return ot(this, (function(u) {
                switch (u.label) {
                    case 0:
                        return 0 !== (r = Pi(t)) ? [3, 2] : [4, ji(t)];
                    case 1:
                        r = u.sent(), u.label = 2;
                    case 2:
                        if (2 === r) return [2];
                        switch (i = e.target, o = c.throttleDom ? function(t, e, n, a) {
                            var r = t.target ? pr(t.target.parentNode) : null;
                            if (r && "HTML" !== r.data.tag) {
                                var i = a > sa,
                                    o = pr(t.target),
                                    u = o && o.selector ? o.selector.join() : t.target.nodeName,
                                    c = [r.selector ? r.selector.join() : "", u, t.attributeName, ma(t.addedNodes), ma(t.removedNodes)].join();
                                la[c] = c in la ? la[c] : [0, n];
                                var s = la[c];
                                if (!1 === i && s[0] >= 10 && ya(s[2], 2, e, a), s[0] = i ? s[1] === n ? s[0] : s[0] + 1 : 1, s[1] = n, s[0] >= 10) return s[2] = t.removedNodes, n > a + 3e3 ? t.type : (ia[c] = {
                                    mutation: t,
                                    timestamp: a
                                }, "throttle")
                            }
                            return t.type
                        }(e, t, n, a) : e.type, o && i && i.ownerDocument && er(i.ownerDocument), o && i && i.nodeType == Node.DOCUMENT_FRAGMENT_NODE && i.host && er(i), o) {
                            case "attributes":
                                fa.indexOf(e.attributeName) < 0 && Ma(i, 3, a);
                                break;
                            case "characterData":
                                Ma(i, 4, a);
                                break;
                            case "childList":
                                ya(e.addedNodes, 1, t, a), ya(e.removedNodes, 2, t, a)
                        }
                        return [2]
                }
            }))
        ...
        return it(this, void 0, void 0, (function() {
            ...
            return ot(this, (function(d) {
                switch (d.label) {
                    ...
                    case 1:
                        if (!(ra.length > 0)) return [3, 7];
                        e = ra.shift(), n = f(), a = 0, r = e.mutations, d.label = 2;
                    case 2:
                        return a < r.length ? (i = r[a], [4, va(t, i, n, e.time)]) : [3, 5];
                    case 3:
                        d.sent(), d.label = 4;
                    case 4:
                        return a++, [3, 2];
                    case 5:
                        return [4, Gn(6, t, e.time)];
                    case 6:
                        return d.sent(), [3, 1];
                    case 7:
                        o = !1, u = 0, c = Object.keys(ia), d.label = 8;
                    case 8:
                        return u < c.length ? (s = c[u], l = ia[s], delete ia[s], [4, va(t, l.mutation, f(), l.timestamp)]) : [3, 11];
                    case 9:
                        d.sent(), o = !0, d.label = 10;
                    case 10:
                        return u++, [3, 8];
                    case 11:
                        return Object.keys(ia).length > 0 && function() {
                            ca && B(ca);
                            ca = V((function() {
                                Ci(ga, 1)
                            }), 33)
                        }(), 0 === Object.keys(ia).length && o ? [4, Gn(6, t, f())] : [3, 13];
                    case 12:
                        d.sent(), d.label = 13;
                    case 13:
                        return function() {
                            var t = f();
                            Object.keys(la).length > 1e4 && (la = {}, q(38));
                            for (var e = 0, n = Object.keys(la); e < n.length; e++) {
                                var a = n[e];
                                t > la[a][1] + 3e4 && delete la[a]
                            }
                        }(), Yi(t), [2]
                }
            }))
        ...
        return it(this, void 0, void 0, (function() {
            ...
            return ot(this, (function(c) {
                switch (c.label) {
                    ...
                    case 1:
                        return i < r ? (o = t[i], 1 !== e ? [3, 2] : (na(o, n, e, a), [3, 5])) : [3, 6];
                    case 2:
                        return 0 !== (u = Pi(n)) ? [3, 4] : [4, ji(n)];
                    case 3:
                        u = c.sent(), c.label = 4;
                    case 4:
                        if (2 === u) return [3, 6];
    ...
    function ba(t) {
        return oa.indexOf(t) < 0 && oa.push(t), ua && B(ua), ua = V((function() {
            ! function() {
                for (var t = 0, e = oa; t < e.length; t++) {
                    ...
                    if (n) {
                        ...
                        if (a && gr(n)) continue;
                        wa(n, a ? "childList" : "characterData")
                    }
                }
                oa = []
            }()
    ...
    function Sa(t) {
        if (null != t && (t.clarityOverrides = t.clarityOverrides || {}, "CSSStyleSheet" in t && t.CSSStyleSheet && t.CSSStyleSheet.prototype && void 0 === t.clarityOverrides.InsertRule && (t.clarityOverrides.InsertRule = t.CSSStyleSheet.prototype.insertRule, t.CSSStyleSheet.prototype.insertRule = function() {
                return du() && ba(this.ownerNode), t.clarityOverrides.InsertRule.apply(this, arguments)
                ...
                return du() && ba(this.parentStyleSheet.ownerNode), t.clarityOverrides.MediaInsertRule.apply(this, arguments)
                ...
                return du() && ba(this.ownerNode), t.clarityOverrides.DeleteRule.apply(this, arguments)
                ...
                return du() && ba(this.parentStyleSheet.ownerNode), t.clarityOverrides.MediaDeleteRule.apply(this, arguments)
            ...
            try {
                t.Element.prototype.attachShadow = function() {
                    return du() ? ba(t.clarityOverrides.AttachShadow.apply(this, arguments)) : t.clarityOverrides.AttachShadow.apply(this, arguments)
                }
            } catch (e) {
    ...
    function Oa(t) {
        for (var e = 0, n = Object.keys(t); e < n.length; e++) {
            ...
            if ("@type" === a && "string" == typeof r) switch (r = (r = r.toLowerCase()).indexOf("article") >= 0 || r.indexOf("posting") >= 0 ? "article" : r) {
                case "article":
                case "recipe":
                    ro(5, t[a]), ro(8, t.creator), ro(18, t.headline);
                    break;
                case "product":
                    ro(5, t[a]), ro(10, t.name), ro(12, t.sku), t.brand && ro(6, t.brand.name);
                    break;
                case "aggregaterating":
                    t.ratingValue && (F(11, Ea(t.ratingValue, 100)), F(18, Ea(t.bestRating)), F(19, Ea(t.worstRating))), F(12, Ea(t.ratingCount)), F(17, Ea(t.reviewCount));
                    break;
                case "offer":
                    ro(7, t.availability), ro(14, t.itemCondition), ro(13, t.priceCurrency), ro(12, t.sku), F(13, Ea(t.price));
                    break;
                case "brand":
                    ro(6, t.name)
            }
    ...
    function Ea(t, e) {
        if (void 0 === e && (e = 1), null !== t) switch (typeof t) {
            ...
            case "string":
                return Math.round(parseFloat(t.replace(ka, "")) * e)
        }
        return null
    }
    var Ta = ["title", "alt", "onload", "onfocus", "onerror", "data-drupal-form-submit-last", "aria-label"],
        _a = /[\r\n]+/g;

    function Ma(e, n, a) {
        var r, i = null;
        if (2 === n && !1 === gr(e)) return i;
        0 !== n && e.nodeType === Node.TEXT_NODE && e.parentElement && "STYLE" === e.parentElement.tagName && (e = e.parentNode);
        var o = !1 === gr(e) ? "add" : "update",
            u = e.parentElement ? e.parentElement : null,
            c = e.ownerDocument !== document;
        switch (e.nodeType) {
            case Node.DOCUMENT_TYPE_NODE:
                u = c && e.parentNode ? or(e.parentNode) : u;
                var s = e,
                    l = {
                        tag: (c ? "iframe:" : "") + "*D",
                        attributes: {
            ...
            case Node.DOCUMENT_NODE:
                e === document && er(document), Nn(e, a), Na(e);
                break;
            case Node.DOCUMENT_FRAGMENT_NODE:
                var d = e;
                if (d.host) {
                    if (er(d), "function" === typeof d.constructor && d.constructor.toString().indexOf("[native code]") >= 0) {
                        Na(d);
                        var f = {
                            tag: "*S",
                            attributes: {
                ...
                break;
            case Node.TEXT_NODE:
                if (u = u || e.parentNode, "update" === o || u && gr(u) && "STYLE" !== u.tagName && "NOSCRIPT" !== u.tagName) {
                    var h = {
                        tag: "*T",
                        value: e.nodeValue
                    };
                ...
                switch (u = e.parentElement ? e.parentElement : e.parentNode ? e.parentNode : null, "http://www.w3.org/2000/svg" === p.namespaceURI && (v = "svg:" + v), v) {
                    ...
                    case "SCRIPT":
                        if ("type" in g && "application/ld+json" === g.type) try {
                            Oa(JSON.parse(p.text.replace(_a, "")))
                        } catch (t) {}
                        break;
                    case "NOSCRIPT":
                        var y = {
                    ...
                    case "IFRAME":
                        ...
                        ir(_) && (! function(t) {
                            !1 === gr(t) && Jo(t, "load", wa.bind(this, t, "childList"), !0)
                        }(_), M.attributes["*O"] = "true", _.contentDocument && _.contentWindow && "loading" !== _.contentDocument.readyState && (i = _.contentDocument)), 2 === n && xa(_), t[o](e, u, M, n);
                        break;
                    case "LINK":
                        if (wo && "stylesheet" === g.rel) {
                    ...
                    default:
                        ! function(t) {
                            var e;
                            (null === (e = window.customElements) || void 0 === e ? void 0 : e.get) && window.customElements.get(t) && Kn(t)
                        }(p.localName);
                        var P = {
                            tag: v,
                            attributes: g
    ...
    function Na(t) {
        gr(t) || Qo(t) || (! function(t) {
            try {
                var e = s("MutationObserver"),
                    n = e in window ? new window[e](Bo(pa)) : null;
                n && (n.observe(t, {
                    attributes: !0,
                    childList: !0,
                    characterData: !0,
                    subtree: !0
                }), da.set(t, n), aa.add(n)), t.defaultView && Sa(t.defaultView)
            } catch (t) {
                Oi(2, 0, t ? t.name : null)
            }
        }(t), gn(t))
    }
    ...
    function xa(t) {
        ...
        var e, n, a = ur(t) || {},
            ...
            o = a.win,
            u = void 0 === o ? null : o;
        u && Zo(u), i && (Zo(i), e = i, (n = da.get(e)) && (n.disconnect(), aa.delete(n), da.delete(e)), cr(t, i))
    }
    ...
    function Ca(t) {
        ...
        try {
            ...
            if (Oi(1, 1, t ? t.name : null), t && "SecurityError" !== t.name) throw t
        }
        if (null !== n)
            for (var a = 0; a < n.length; a++) e += n[a].cssText;
        return e
    }
    var Da = ["load", "active", "fixed", "visible", "focus", "show", "collaps", "animat"],
        Pa = {};
            ...
            default:
                ...
                if (u && u.length > 0)
                    if (0 === e) {
                        ...
                        c in Pa || (Pa[c] = []), Pa[c].indexOf(t.id) < 0 && Pa[c].push(t.id), i = "".concat(c).concat("~").concat(Pa[c].indexOf(t.id))
                    } else i = "".concat(a).concat(t.tag, ".").concat(u).concat(r);
                return i = o && Ya(o) ? "".concat(function(t) {
    ...
    function tr() {
        ja = 1, Xa = [], La = [], za = {}, Wa = [], Ha = [], qa = Jt, Ua = Zt, Fa = Gt, Va = Qt, Aa = new Map, Ba = new WeakMap, Ka = new WeakMap, Ja = new WeakMap, Ga = new WeakMap, Za = new WeakMap, Pa = {}
    }
    ...
    function er(t, e) {
        ...
        try {
            e && c.unmask.forEach((function(t) {
                return t.indexOf("!") < 0 ? Ha.push(t) : Wa.push(t.substr(1))
    ...
    function nr(t, e) {
        ...
        var n = Ba.get(t);
        return !n && e && (n = ja++, Ba.set(t, n)), n || null
    }
    ...
    function ar(t, e, n, a) {
        ...
        if (e && r || null != t.host || t.nodeType === Node.DOCUMENT_TYPE_NODE) {
            var i = nr(t, !0),
                ...
                d = c.content ? 1 : 3;
            r >= 0 && Xa[r] && ((u = Xa[r]).children.push(i), s = null === s ? u.region : s, l = null === l ? u.metadata.fraud : l, d = u.metadata.privacy), n.attributes && "data-clarity-region" in n.attributes && (Mr(t, n.attributes["data-clarity-region"]), s = i), Aa.set(i, t), Xa[i] = {
                    id: i,
                    parent: r,
                    previous: o,
                    children: [],
                ...
                function(t, e, n) {
                    ...
                    switch (!0) {
                        case Va.indexOf(c) >= 0:
                            ...
                            var f = Ua.some((function(t) {
                                return l.indexOf(t) >= 0
                            }));
                            i.privacy = "INPUT" === c && Fa.indexOf(s) >= 0 ? o : f ? 4 : 2;
                            break;
                        ...
                        case "*T" === c:
                            ...
                            i.privacy = v.includes(h) || Wa.some((function(t) {
                ...
                function(t) {
                    if ("IMG" === t.data.tag && 3 === t.metadata.privacy) {
                        var e = fr(t.id);
                        !e || e.complete && 0 !== e.naturalWidth || Jo(e, "load", (function() {
                            e.setAttribute("data-clarity-loaded", "".concat(Ao()))
                        })), t.metadata.size = []
                    }
                }(Xa[i]), wr(i, a)
        }
        ...
        if (r in Xa) {
            ...
            if (s.metadata.active = !0, s.previous !== o && (u = !0, s.previous = o), s.parent !== i) {
                ...
                if (s.parent = i, null !== i && i >= 0) {
                    var d = null === o ? 0 : Xa[i].children.indexOf(o) + 1;
                    Xa[i].children.splice(d, 0, r), s.region = Nr(t) ? r : Xa[i].region
                } else ! function(t, e) {
                    if (t in Xa) {
                        var n = Xa[t];
                        n.metadata.active = !1, n.parent = null, wr(t, e), yr(t)
                    }
                }(r, a);
                if (null !== l && l >= 0) {
                    var f = Xa[l].children.indexOf(r);
                    f >= 0 && Xa[l].children.splice(f, 1)
                }
                c = !0
            }
            for (var h in n) sr(s.data, n, h) && (u = !0, s.data[h] = n[h]);
            lr(s), wr(r, a, u, c)
        }
    }
    ...
    function ir(t) {
        ...
        if (t.nodeType === Node.ELEMENT_NODE && "IFRAME" === t.tagName) {
            var n = t;
            try {
                n.contentDocument && (Ka.set(n.contentDocument, n), Ja.set(n, {
    ...
    function or(t) {
        ...
        return e && Ka.has(e) ? Ka.get(e) : null
    }
    ...
    function lr(t) {
        var e = t.parent && t.parent in Xa ? Xa[t.parent] : null,
            n = e ? e.selector : null,
            a = t.data,
            r = function(t, e) {
                e.metadata.position = 1;
                for (var n = t ? t.children.indexOf(e.id) : -1; n-- > 0;) {
                    var a = Xa[t.children[n]];
        ...
        t.selector = [Ra(i, 0), Ra(i, 1)], t.hash = t.selector.map((function(t) {
            return t ? p(t) : null
    ...
    function pr(t) {
        var e = nr(t);
        return e in Xa ? Xa[e] : null
    }

    function vr(t) {
        return t in za ? za[t] : null
    }
    ...
    function yr(t) {
        ...
        if ((null == e ? void 0 : e.nodeType) !== Node.DOCUMENT_FRAGMENT_NODE) {
            if (e && (null == e ? void 0 : e.nodeType) === Node.ELEMENT_NODE && "IFRAME" === e.tagName) xa(e);
            Aa.delete(t);
            var n = t in Xa ? Xa[t] : null;
            if (n && n.children)
    ...
    function br(t) {
        for (var e = null; null === e && t.previousSibling;) e = nr(t.previousSibling), t = t.previousSibling;
        return e
    }
    ...
    function wr(t, e, n, a) {
        if (void 0 === n && (n = !0), void 0 === a && (a = !1), !c.lean || !c.lite) {
            var r = La.indexOf(t);
            r >= 0 && 1 === e && a ? (La.splice(r, 1), La.push(t)) : -1 === r && n && La.push(t)
        }
    }
    var Sr = [],
        kr = null,
    ...
    function Mr(t, e) {
        !1 === kr.has(t) && (kr.set(t, e), (_r = null === _r && Tr ? new IntersectionObserver(Ir, {
            threshold: [0, .05, .1, .2, .3, .4, .5, .6, .7, .8, .9, 1]
        }) : _r) && t && t.nodeType === Node.ELEMENT_NODE && _r.observe(t))
    }
    ...
    function xr() {
        for (var t = [], e = 0, n = Er; e < n.length; e++) {
            var a = n[e],
                r = nr(a.node);
            r ? (a.state.data.id = r, Or[r] = a.state.data, Sr.push(a.state)) : t.push(a)
        }
        Er = t, Sr.length > 0 && Gn(7)
    }
    ...
    function Ir(t) {
        for (var e = 0, n = t; e < n.length; e++) {
            var a = n[e],
                ...
                u = a.rootBounds;
            if (kr.has(r) && i.width + i.height > 0 && u && u.width > 0 && u.height > 0) {
                var c = r ? nr(r) : null,
                    s = c in Or ? Or[c] : {
                        id: c,
                        name: kr.get(r),
                ...
                Cr(r, s, s.interaction, d ? 13 : l ? 10 : 0), s.visibility >= 13 && _r && _r.unobserve(r)
            }
        }
        Sr.length > 0 && Gn(7)
    }
    ...
    function Cr(t, e, n, a) {
        ...
        e.interaction = n > e.interaction ? n : e.interaction, e.visibility = a > e.visibility ? a : e.visibility, e.id ? (e.id in Or && r || !(e.id in Or)) && (Or[e.id] = e, Sr.push(Dr(e))) : Er.push({
            node: t,
            state: Dr(e)
        })
    }
    ...
    function Rr(t) {
        ...
        return sa = f() + 3e3, n && n.nodeType === Node.DOCUMENT_NODE ? n.documentElement : n
    }
        ...
        return void 0 === e && (e = null), it(this, void 0, void 0, (function() {
            ...
            return ot(this, (function(q) {
                switch (n = e || f(), a = [n, t], t) {
                    ...
                    case 19:
                    case 20:
                        for (r = 0, i = Oe; r < i.length; r++) z = i[r], (o = Yr(z.data.target, z.event)).id > 0 && ((a = [z.time, z.event]).push(o.id), a.push(z.data.x), a.push(z.data.y), void 0 !== z.data.id && (a.push(z.data.id), void 0 !== z.data.isPrimary && a.push(z.data.isPrimary.toString())), di(a), (void 0 === z.data.isPrimary || z.data.isPrimary) && D(z.event, z.data.x, z.data.y, z.time));
                        De();
                        break;
                    case 9:
                    case 48:
                        for (u = 0, c = ie; u < c.length; u++) z = c[u], s = Yr(z.data.target, z.event, z.data.text), a = [z.time, z.event], l = s.hash ? s.hash.join(".") : "", a.push(s.id), a.push(z.data.x), a.push(z.data.y), a.push(z.data.eX), a.push(z.data.eY), a.push(z.data.button), a.push(z.data.reaction), a.push(z.data.context), a.push(S(z.data.text, "click", s.privacy)), a.push(k(z.data.link)), a.push(l), a.push(z.data.trust), a.push(z.data.isFullText), a.push(z.data.w), a.push(z.data.h), a.push(z.data.tag), a.push(z.data.class), a.push(z.data.id), a.push(z.data.source), di(a), zr(z.time, z.event, l, z.data.x, z.data.y, z.data.reaction, z.data.context);
                        fe();
                        break;
                    case 38:
                        for (d = 0, h = he; d < h.length; d++) z = h[d], a = [z.time, z.event], (A = Yr(z.data.target, z.event)).id > 0 && (a.push(A.id), a.push(z.data.action), di(a));
                        ve();
                        break;
                    case 11:
                        p = ke, a.push(p.width), a.push(p.height), D(t, p.width, p.height), Le(), di(a);
                        break;
                    case 26:
                        v = en, a.push(v.name), a.push(v.persisted), sn(), di(a);
                        break;
                    case 27:
                        for (g = 0, m = me; g < m.length; g++) z = m[g], y = Yr(z.data.target, z.event, z.data.value), (a = [z.time, z.event]).push(y.id), a.push(S(z.data.value, "input", y.privacy, !1, z.data.type)), a.push(z.data.trust), di(a);
                        Se();
                        break;
                    case 21:
                        (b = Je) && (w = Yr(b.start, t), O = Yr(b.end, t), a.push(w.id), a.push(b.startOffset), a.push(O.id), a.push(b.endOffset), tn(), di(a));
                        break;
                    case 10:
                        for (E = 0, T = ze; E < T.length; E++) z = T[E], _ = Yr(z.data.target, z.event), M = Yr(z.data.top, z.event), N = Yr(z.data.bottom, z.event), x = (null == M ? void 0 : M.hash) ? M.hash.join(".") : "", I = (null == N ? void 0 : N.hash) ? N.hash.join(".") : "", _.id > 0 && ((a = [z.time, z.event]).push(_.id), a.push(z.data.x), a.push(z.data.y), a.push(x), a.push(I), a.push(z.data.trust), di(a), D(z.event, z.data.x, z.data.y, z.time));
                        ze = [], We = null, He = null;
                        break;
                    case 42:
                        for (C = 0, P = $t; C < P.length; C++) z = P[C], a = [z.time, z.event], (A = Yr(z.data.target, z.event)).id > 0 && ((a = [z.time, z.event]).push(A.id), a.push(z.data.type), a.push(S(z.data.value, "change", A.privacy)), a.push(S(z.data.checksum, "checksum", A.privacy)), di(a));
                        ee();
                        break;
                    case 39:
                        for (Y = 0, j = rn; Y < j.length; Y++) z = j[Y], a = [z.time, z.event], (A = Yr(z.data.target, z.event)).id > 0 && (a.push(A.id), di(a));
                        un();
                        break;
                    case 22:
                        for (X = 0, L = Xr; X < L.length; X++) z = L[X], (a = [z.time, z.event]).push(z.data.type), a.push(z.data.hash), a.push(z.data.x), a.push(z.data.y), a.push(z.data.reaction), a.push(z.data.context), di(a, !1);
                        Lr();
                        break;
                    case 28:
                        W = nn, a.push(W.visible), di(a), R(n, W.visible), dn();
                        break;
                    case 50:
                        H = an, a.push(H.focused), di(a, !1), fn()
                }
                return [2]
            }))
        }))
                ...
                for (; e.length > 0;) {
                    ...
                    switch (i.nodeType) {
                        case Node.DOCUMENT_TYPE_NODE:
                            ...
                            break;
                        case Node.TEXT_NODE:
                            r = i.nodeValue, a = Ur.get(u) ? "*T" : a;
                            break;
                        case Node.ELEMENT_NODE:
                            var s = i;
                            n = Vr(s), a = ["NOSCRIPT", "SCRIPT", "STYLE"].indexOf(s.tagName) < 0 ? s.tagName : a
                    }
                    Br(i, u, {
                        tag: a,
                        attributes: n,
            ...
            function(t) {
                it(this, void 0, void 0, (function() {
                    ...
                    return ot(this, (function(v) {
                        switch (e = f(), n = [e, t], t) {
                            case 8:
                                a = Fn, n.push(a.width), n.push(a.height), D(t, a.width, a.height), di(n);
                                break;
                            case 43:
                                if ((r = Hr).length > 0) {
                                        ...
                                        for (u = o[i], c = u.metadata.privacy, s = u.data, l = 0, d = ["tag", "attributes", "value"]; l < d.length; l++)
                                            if (s[h = d[l]]) switch (h) {
                                                case "tag":
                                                    ...
                                                    break;
                                                case "attributes":
                                                    for (p in s[h]) void 0 !== s[h][p] && n.push(Wr(p, s[h][p], c, s.tag));
                                                    break;
                                                case "value":
    ...
    function Br(t, e, n) {
        if (t && n && n.tag) {
            var a = function(t) {
                    return null === t ? null : Ur.has(t) ? Ur.get(t) : (Ur.set(t, qr), qr++)
                }(t),
                r = e ? Ur.get(e) : null,
                i = t.previousSibling ? Ur.get(t.previousSibling) : null;
            Hr.push({
                id: a,
                parent: r,
                previous: i,
    ...
    function Zr(t) {
        Jr && "function" == typeof t && Kr.push(t)
    }
    ...
    function Qr(t) {
        if (Jr) {
            ...
            n && Gr.has(n) || function(t, e) {
                try {
                    var n = document.createElement("script");
                    n.src = t, n.async = !0, n.onload = function() {
                        e && (Gr.add(e), Y(Gr))
                    }, n.onerror = function() {
                        Vo(new Error("".concat("MODULE", ": ").concat(t)))
                    }, document.head.appendChild(n)
                } catch (t) {}
            }(e[0], n)
        }
    }
    var $r, ti, ei, ni, ai, ri = Object.freeze({
            __proto__: null,
            event: Qr,
            register: Zr,
            start: function() {
                Jr = !0, Gr = new Set, c.modules && c.modules.length > 0 && c.modules.forEach((function(t) {
                    Qr(t)
                }))
            },
            stop: function() {
                Kr.reverse().forEach((function(t) {
                    try {
                        t()
                    } catch (t) {}
                })), Kr = [], Jr = !1
    ...
    function li() {
        ni = !0, ii = 0, oi = 0, si = !1, ci = 0, $r = [], ti = [], ei = {}, ai = null
    }
    ...
    function di(t, e) {
        if (void 0 === e && (e = !0), ni) {
            var n = f(),
                ...
                r = JSON.stringify(t);
            switch (c.lean ? !si && oi + r.length > 10485760 && (Oi(10, 0), si = !0) : si = !1, a) {
                case 5:
                    if (si) break;
                    ii += r.length;
                case 37:
            ...
            q(25);
            var i = function() {
                var t = !1 === c.lean && ii > 0 ? 100 : Wo.sequence * c.delay;
                return "string" == typeof c.upload ? Math.max(Math.min(t, 3e4), 100) : c.delay
            }();
            n - ci > 2 * i && (B(ui), ui = null), e && null === ui && (25 !== a && Z(), ui = V(hi, i), ci = n, Ji(oi))
        }
    }

    function fi() {
        B(ui), hi(!0), ii = 0, oi = 0, si = !1, ci = 0, $r = [], ti = [], ei = {}, ai = null, ni = !1
    }
    ...
    function hi(t) {
        return void 0 === t && (t = !1), it(this, void 0, void 0, (function() {
            ...
            return ot(this, (function(l) {
                switch (l.label) {
                    case 0:
                        return ni ? (ui = null, (e = !1 === c.lean && oi > 0 && (oi < 1048576 || Wo.sequence > 0)) && F(1, 1), xr(), function() {
                            if (Wo) {
                                var t = [];
                                Xr = [];
                                for (var e = (Wo.start || 0) + (Wo.duration || 0), n = Math.max(e - 2e3, 0), a = 0, r = Ar; a < r.length; a++) {
                                    var i = r[a];
                                    i.time >= n && (i.time <= e && Xr.push(i), t.push(i))
                                }
                                Ar = t, jr(22)
                            }
                        }(), Ft(), function() {
                            for (var t = 0, e = En; t < e.length; t++) {
                                var n = e[t],
                                    a = n == document ? -1 : nr(n);
                                Nn(n, a in On ? On[a] : null)
                            }
                        }(), n = !0 === t, Wo ? (a = JSON.stringify(Uo(n)), r = "[".concat(ti.join(), "]"), i = e ? "[".concat($r.join(), "]") : "", n && i.length > 0 && a.length + r.length + i.length > 65536 && (i = ""), o = function(t) {
                    ...
                    case 2:
                        s = l.sent(), l.label = 3;
                    case 3:
                        return U(2, (u = s) ? u.length : o.length), pi(o, u, Wo.sequence, n), ti = [], e && ($r = [], oi = 0, ii = 0, si = !1), [2]
                }
            }))
        }))
    }
    ...
    function pi(t, e, n, a) {
        if (void 0 === a && (a = !1), "string" == typeof c.upload) {
            ...
            if (a && navigator && navigator.sendBeacon) try {
                (i = navigator.sendBeacon.bind(navigator)(r, t)) && gi(n)
            } catch (t) {}
            if (!1 === i) {
                n in ei ? ei[n].attempts++ : ei[n] = {
                    data: t,
                    attempts: 1
                };
                var o = new XMLHttpRequest;
                o.open("POST", r, !0), o.timeout = 15e3, o.ontimeout = function() {
                    Vo(new Error("".concat("Timeout", " : ").concat(r)))
    ...
    function vi(t, e) {
        var n = ei[e];
        t && 4 === t.readyState && n && ((t.status < 200 || t.status > 208) && n.attempts <= 1 ? t.status >= 400 && t.status < 500 ? Gi(6) : (0 === t.status && (c.upload = c.fallback ? c.fallback : c.upload), ai = {
            sequence: e,
            attempts: n.attempts,
            status: t.status
        }, Bi(2), pi(n.data, null, e)) : (ai = {
            sequence: e,
            attempts: n.attempts,
            status: t.status
        }, n.attempts > 1 && Bi(2), 200 === t.status && t.responseText && function(t) {
        ...
        }(t.responseText), 0 === t.status && (pi(n.data, null, e, !0), Gi(3)), t.status >= 200 && t.status <= 208 && gi(e), delete ei[e]))
    }
    ...
    function bi(t) {
        var e = t.error || t;
        return e.message in yi || (yi[e.message] = 0), yi[e.message]++ >= 5 || e && e.message && (mi = {
            message: e.message,
            line: t.lineno,
            column: t.colno,
            stack: e.stack,
    ...
    function wi(t) {
        return it(this, void 0, void 0, (function() {
            ...
            return ot(this, (function(n) {
                switch (e = [f(), t], t) {
                    case 31:
                        e.push(mi.message), e.push(mi.line), e.push(mi.column), e.push(mi.stack), e.push(k(mi.source)), di(e);
                        break;
                    case 33:
                        Si && (e.push(Si.code), e.push(Si.name), e.push(Si.message), e.push(Si.stack), e.push(Si.severity), di(e, !1));
                        break;
                    case 41:
                        Vt && (e.push(Vt.id), e.push(Vt.target), e.push(Vt.checksum), di(e, !1))
                }
                return [2]
            }))
        }))
    ...
    function Oi(t, e, n, a, r) {
        void 0 === n && (n = null), void 0 === a && (a = null), void 0 === r && (r = null);
        var i = n ? "".concat(n, "|").concat(a) : "";
        t in ki && ki[t].indexOf(i) >= 0 || (Si = {
            code: t,
            name: n,
            message: a,
            stack: r,
            severity: e
        }, t in ki ? ki[t].push(i) : ki[t] = [i], wi(33))
    }
    var Ei = 5e3,
        Ti = {},
        _i = [],
    ...
    function Di() {
        ...
        t && (Mi = t, t.task().then((function() {
            t.id === No() && (t.resolve(), Mi = null, Di())
        })).catch((function(e) {
            t.id === No() && (e && Oi(0, 1, e.name, e.message, e.stack), Mi = null, Di())
        })))
    }
    ...
    function Yi(t) {
        var e = performance.now(),
            n = Ai(t),
            a = e - Ti[n].start;
        U(t.cost, a), q(5), Ti[n].calls > 0 && U(4, a)
    }
    ...
    function ji(t) {
        ...
        return it(this, void 0, void 0, (function() {
            ...
            return ot(this, (function(r) {
                switch (r.label) {
                    case 0:
                        return (n = Ai(t)) in Ti ? (Yi(t), a = Ti[n], [4, Xi()]) : [3, 2];
                    case 1:
                        a.yield = (null === (e = r.sent()) || void 0 === e ? void 0 : e.timeRemaining()) || 30,
                            function(t) {
                                ...
                                if (Ti && Ti[e]) {
                                    var n = Ti[e].calls,
                                        a = Ti[e].yield;
                                    Ri(t), Ti[e].calls = n + 1, Ti[e].yield = a
                                }
                            }(t), r.label = 2;
                    case 2:
    ...
    var Li = window.requestIdleCallback || function(t, e) {
        ...
        return it(this, void 0, void 0, (function() {
            ...
            return ot(this, (function(n) {
                switch (n.label) {
                    ...
                    case 1:
                        return n.sent(), Nn(document, t), [4, Gn(5, e, t)];
                    case 2:
                        return n.sent(), Yi(e), [2]
                }
            }))
        }))
    }
    ...
    function Ui() {
        !c.lean && c.upgrade && c.upgrade("Config"), qi = null
    }

    function Fi(t) {
        du() && c.lean && (c.lean = !1, qi = {
            key: t
        }, Ro(), Yo(), c.upgrade && c.upgrade(t), Bi(3), c.lite && (zi(), Mn()))
    }
    ...
    function Bi(t) {
        ...
        switch (t) {
            case 4:
                var n = N;
                n && n.data && ((e = [n.time, n.event]).push(n.data.visible), e.push(n.data.docWidth), e.push(n.data.docHeight), e.push(n.data.screenWidth), e.push(n.data.screenHeight), e.push(n.data.scrollX), e.push(n.data.scrollY), e.push(n.data.pointerX), e.push(n.data.pointerY), e.push(n.data.activityTime), e.push(n.data.scrollTime), e.push(n.data.pointerTime), e.push(n.data.moveX), e.push(n.data.moveY), e.push(n.data.moveTime), e.push(n.data.downX), e.push(n.data.downY), e.push(n.data.downTime), e.push(n.data.upX), e.push(n.data.upY), e.push(n.data.upTime), e.push(n.data.pointerPrevX), e.push(n.data.pointerPrevY), e.push(n.data.pointerPrevTime), e.push(n.data.modules), di(e, !1)), C();
                break;
            case 25:
                e.push(z.gap), di(e);
                break;
            case 35:
                e.push(Hi.check), di(e, !1);
                break;
            case 3:
                e.push(qi.key), di(e);
                break;
            case 2:
                e.push(ai.sequence), e.push(ai.attempts), e.push(ai.status), di(e, !1);
                break;
            case 24:
                X.key && e.push(X.key), e.push(X.value), di(e);
                break;
            case 34:
            ...
            case 0:
                ...
                break;
            case 1:
                var h = Object.keys(to);
                if (h.length > 0) {
                    for (var p = 0, v = h; p < v.length; p++) {
                        var g = v[p];
                        d = parseInt(g, 10);
                        e.push(d), e.push(to[g])
                    }
                    oo(), di(e, !1)
                }
                break;
            ...
            case 40:
                ...
                break;
            case 47:
                e.push(uo.source), e.push(uo.ad_Storage), e.push(uo.analytics_Storage), di(e, !1)
        }
    }
    ...
    function Ji(t) {
        if (0 === Hi.check) {
            var e = Hi.check;
            e = Wo.sequence >= 128 ? 1 : e, e = Wo.pageNum >= 128 ? 7 : e, e = f() > 72e5 ? 2 : e, (e = t > 10485760 ? 2 : e) !== Hi.check && Gi(e)
        }
    }

    function Gi(t) {
        Hi.check = t, 5 !== t && (Po(), ju())
    }
    ...
    function ro(t, e) {
        if (e && (e = "".concat(e), t in $i || ($i[t] = []), $i[t].indexOf(e) < 0)) {
            if ($i[t].length > 128) return void(eo || (eo = !0, Gi(5)));
            $i[t].push(e), t in to || (to[t] = []), to[t].push(e)
        }
    }
    ...
    function so() {
        ...
        co = !0, (null == e ? void 0 : e.addListener) && e.addListener(["ad_storage", "analytics_storage"], fo)
    }
    ...
    function ho(t) {
        vo(t.analytics_Storage ? 1 : 0), uo = t
    }
    ...
    function Eo() {
        ...
        var s = function() {
                ...
                if (e) {
                    ...
                    n.length >= 5 && t.ts - Xo(n[1]) < 18e5 && (t.session = n[0], t.count = Xo(n[2]) + 1, t.upgrade = Xo(n[3]), t.upload = n.length >= 6 ? "".concat("https://").concat(n[5], "/").concat(n[4]) : "".concat("https://").concat(n[4]))
                }
                return t
            }(),
            l = Lo(),
        ...
        yo = {
            ...
            sessionId: s.session,
            pageNum: s.count
        }, c.lean = c.track && null !== s.upgrade ? 0 === s.upgrade : c.lean, c.upload = c.track && "string" == typeof c.upload && s.upload && s.upload.length > "https://".length ? s.upload : c.upload, ro(0, a), ro(3, u), ro(1, k(location.href, !!wo)), ro(2, document.referrer), ro(15, function() {
            var t = Ao();
            ...
            return t
        }()), ro(16, document.documentElement.lang), ro(17, document.dir), ro(26, "".concat(window.devicePixelRatio)), ro(28, l.dob.toString()), ro(29, l.version.toString()), ro(33, o), ro(34, r), ro(35, i), F(0, s.ts), F(1, 0), F(35, wo);
        var f, h = null === window || void 0 === window ? void 0 : window.Zone;
        h && "__symbol__" in h && F(39, 1), navigator && (ro(9, navigator.language), F(33, navigator.hardwareConcurrency), F(32, navigator.maxTouchPoints), F(34, Math.round(navigator.deviceMemory)), (f = navigator.userAgentData) && f.getHighEntropyValues ? f.getHighEntropyValues(["model", "platform", "platformVersion", "uaFullVersion"]).then((function(t) {
            var e;
            ro(22, t.platform), ro(23, t.platformVersion), null === (e = t.brands) || void 0 === e || e.forEach((function(t) {
                ro(24, t.name + "~" + t.version)
            })), ro(25, t.model), F(27, t.mobile ? 1 : 0)
        })) : ro(22, navigator.platform)), screen && (F(14, Math.round(screen.width)), F(15, Math.round(screen.height)), F(16, Math.round(screen.colorDepth))), null === So && (So = {
    ...
    function To() {
        if (!ko && "granted" === (null == So ? void 0 : So.analytics_Storage) && "granted" === (null == So ? void 0 : So.ad_Storage)) {
    ...
    function _o() {
        yo = null, ko = !1, bo.forEach((function(t) {
            t.called = !1
        }))
    }
    ...
    function Mo(t, e, n, a) {
        ...
        var r = c.lean ? 0 : 1,
            i = !1;
        yo && (r || !1 === e) && (t(yo, !c.lean, a ? So : void 0), i = !0), !n && i || bo.push({
            callback: t,
            wait: e,
            recall: n,
            called: i,
    ...
    function No() {
        return yo ? [yo.userId, yo.sessionId, yo.pageNum].join(".") : ""
    }
    ...
    function Io(t, e) {
        var n;
        if (void 0 === t && (t = Oo), void 0 === e && (e = 5), du()) {
            var a = {
                source: null !== (n = t.source) && void 0 !== n ? n : e,
                ad_Storage: Do(t.ad_Storage, null == So ? void 0 : So.ad_Storage),
                analytics_Storage: Do(t.analytics_Storage, null == So ? void 0 : So.analytics_Storage)
            };
            if (So && a.ad_Storage === So.ad_Storage && a.analytics_Storage === So.analytics_Storage) return So.source = a.source, go(Co(So)), void po();
            So = a, Ro(!0);
            var r = Co(So);
            if (!r.analytics_Storage && c.track) return c.track = !1, Po(!0), ju(), void window.setTimeout(Yu, 250);
            du() && r.analytics_Storage && (c.track = !0, jo(Lo(), 1), Yo()), To(), go(r), po()
        }
    }
            ...
            function(t, e) {
                ...
                if (bo.length > 0)
                    for (var n = 0; n < bo.length; n++) {
                        var a = bo[n];
                        a.callback && (!a.called && !e || a.consentInfo && e) && (!a.wait || t) && (a.callback(yo, !c.lean, a.consentInfo ? So : void 0), a.called = !0, a.recall || (bo.splice(n, 1), n--))
                    }
            }(c.lean ? 0 : 1, t)
    }
    ...
    function Yo() {
        if (yo && c.track) {
            var t = Math.round(Date.now()),
                ...
                n = c.lean ? 0 : 1;
            Lt("_clsk", [yo.sessionId, t, yo.pageNum, n, e].join(At), 1)
        }
    }
    ...
    function jo(t, e) {
        ...
        (null === t.expiry || Math.abs(n - t.expiry) >= 1 || t.consent !== e || t.dob !== a) && Lt("_clck", [yo.userId, 2, n.toString(36), e, a].join(At), 365)
    }
    ...
    function Lo() {
        ...
        if (e && e.length > 0) {
            var n = e.includes("^") ? e.split("^") : e.split("|");
            n.length > 1 && (t.version = Xo(n[1])), n.length > 2 && (t.expiry = Xo(n[2], 36)), n.length > 3 && 1 === Xo(n[3]) && (t.consent = 1), n.length > 4 && Xo(n[1]) > 1 && (t.dob = Xo(n[4])), c.track = c.track || 1 === t.consent, t.id = c.track ? n[0] : t.id
        }
        return t
    }
    var zo, Wo = null;
    ...
    function Uo(t) {
        return Wo.start = Wo.start + Wo.duration, Wo.duration = f() - Wo.start, Wo.sequence++, Wo.upload = t && "sendBeacon" in navigator ? 1 : 0, Wo.end = t ? 1 : 0, Wo.applicationPlatform = 0, Wo.url = k(location.href, !1, !0), [Wo.version, Wo.sequence, Wo.start, Wo.duration, Wo.projectId, Wo.userId, Wo.sessionId, Wo.pageNum, Wo.upload, Wo.end, Wo.applicationPlatform, Wo.url]
    }
    ...
    function Vo(t) {
        if (zo && -1 === zo.indexOf(t.message)) {
            ...
            if (e && e.length > 0 && Wo) {
                ...
                a.open("POST", e, !0), a.send(JSON.stringify(n)), zo.push(t.message)
            }
        }
        return t
    }
    ...
    function Bo(t) {
        return function() {
            ...
            U(4, n), n > 30 && (q(7), F(6, n), t.dn && Oi(9, 0, "".concat(t.dn, "-").concat(n)))
        }
    }
    var Ko = new Map;

    function Jo(t, e, n, a, r) {
        void 0 === a && (a = !1), void 0 === r && (r = !0), n = Bo(n);
        try {
            t[s("addEventListener")](e, n, {
                capture: a,
                passive: r
            }), Qo(t) || Ko.set(t, []), Ko.get(t).push({
                event: e,
                listener: n,
                options: {
                    capture: a,
    ...
    function ru() {
        return !(au++ > 20) || (Oi(4, 0), !1)
    }

    function iu() {
        au = 0, nu !== uu() && (ju(), window.setTimeout(ou, 250))
    }
    ...
    function su() {
        cu = !0, l = d(), Ii(), Go(), Fo(),
            function() {
                if (nu = uu(), au = 0, Jo(window, "popstate", iu), null === tu) try {
                    tu = history.pushState, history.pushState = function() {
                        tu.apply(this, arguments), du() && ru() && iu()
                    }
                } catch (t) {
                    tu = null
                }
                if (null === eu) try {
                    eu = history.replaceState, history.replaceState = function() {
                        eu.apply(this, arguments), du() && ru() && iu()
                    }
                } catch (t) {
                    eu = null
                }
    ...
    function lu() {
        nu = null, au = 0, Fo(), Go(), Ii(), l = 0, cu = !1
    }
    ...
    var pu = Object.freeze({
        ...
        hashText: dr,
        start: function() {
            ta(), ea(), Pr(), _r = null, kr = new WeakMap, Or = {}, Er = [], Tr = !!window.IntersectionObserver, Qa(), c.delayDom ? Jo(window, "load", (function() {
                    ha()
                })) : ha(),
                function() {
                    var t;
                    try {
                        window.clarityOverrides = window.clarityOverrides || {}, (null === (t = window.customElements) || void 0 === t ? void 0 : t.define) && !window.clarityOverrides.define && (window.clarityOverrides.define = window.customElements.define, window.customElements.define = function() {
                            return du() && Kn(arguments[0]), window.clarityOverrides.define.apply(this, arguments)
                        })
                    } catch (t) {}
                }(), zi(), Mn(),
                function() {
                    if (window.Animation && window.Animation.prototype && window.KeyframeEffect && window.KeyframeEffect.prototype && window.KeyframeEffect.prototype.getKeyframes && window.KeyframeEffect.prototype.getTiming && (Wn(), qn(Pn, "play"), qn(Rn, "pause"), qn(Yn, "commitStyles"), qn(jn, "cancel"), qn(An, "finish"), null === Dn && (Dn = Element.prototype.animate, Element.prototype.animate = function() {
                            var t = Dn.apply(this, arguments);
                            return Un(t, "play"), t
                        }), document.getAnimations))
                        for (var t = 0, e = document.getAnimations(); t < e.length; t++) {
                            var n = e[t];
                            "finished" === n.playState ? Un(n, "finish") : "paused" === n.playState || "idle" === n.playState ? Un(n, "pause") : "running" === n.playState && Un(n, "play")
                        }
                }()
        },
        stop: function() {
            Pr(), kr = null, Or = {}, Er = [], _r && (_r.disconnect(), _r = null), Tr = !1, $a(),
                function() {
                    for (var t = 0, e = Array.from(aa); t < e.length; t++) {
                        var n = e[t];
                        n && n.disconnect()
                    }
                    aa = new Set, la = {}, ra = [], ia = {}, oa = [], sa = 0, ua = null, da = new WeakMap
                }(), ta(), kn = {}, On = {}, En = [], Tn = [], xn(), Wn(), Jn(), Bn.clear()
        }
    });
    var vu = null;
        ...
        vu = {
            ...
            function(t) {
                it(this, void 0, void 0, (function() {
                    var e, n;
                    return ot(this, (function(a) {
                        return e = f(), n = [e, t], 29 === t && (n.push(vu.fetchStart), n.push(vu.connectStart), n.push(vu.connectEnd), n.push(vu.requestStart), n.push(vu.responseStart), n.push(vu.responseEnd), n.push(vu.domInteractive), n.push(vu.domComplete), n.push(vu.loadEventStart), n.push(vu.loadEventEnd), n.push(vu.redirectCount), n.push(vu.size), n.push(vu.type), n.push(vu.protocol), n.push(vu.encodedSize), n.push(vu.decodedSize), gu(), di(n)), [2]
                    }))
                }))
            }(29)
    }
    var yu, bu = 0,
        ...
        _u = function() {
            ...
            var t = Math.min(Ou.length - 1, Math.floor((Tu() - ku) / 50));
            return Ou[t].latency
        },
        Mu = function() {
            ku = Tu(), Ou.length = 0, Eu.clear()
        },
        Nu = function(t) {
            if (t.interactionId && !(t.duration < 40)) {
                ! function(t) {
                    "interactionCount" in performance ? bu = performance.interactionCount : t.interactionId && (wu = Math.min(wu, t.interactionId), Su = Math.max(Su, t.interactionId), bu = Su ? (Su - wu) / 7 + 1 : 0)
                }(t);
                var e = Ou[Ou.length - 1],
                    n = Eu.get(t.interactionId);
                if (n || Ou.length < 10 || t.duration > (null == e ? void 0 : e.latency)) {
                    if (n) t.duration > n.latency && (n.latency = t.duration);
                        ...
                        Eu.set(a.id, a), Ou.push(a)
                    }
                    Ou.sort((function(t, e) {
                        return e.latency - t.latency
                    })), Ou.length > 10 && Ou.splice(10).forEach((function(t) {
                        return Eu.delete(t.id)
                    }))
                }
            }
        },
        xu = ["navigation", "resource", "longtask", "first-input", "layout-shift", "largest-contentful-paint", "event"];

    function Iu() {
        try {
            yu && yu.disconnect(), yu = new PerformanceObserver(Bo(Cu));
            for (var t = 0, e = xu; t < e.length; t++) {
                var n = e[t];
                PerformanceObserver.supportedEntryTypes.indexOf(n) >= 0 && ("layout-shift" === n && U(9, 0), yu.observe({
                    type: n,
                    buffered: !0
                }))
            }
        ...
        ! function(t) {
            for (var e = (!("visibilityState" in document) || "visible" === document.visibilityState), n = 0; n < t.length; n++) {
                ...
                switch (a.entryType) {
                    ...
                    case "resource":
                        var r = a.name;
                        ro(4, Pu(r)), r !== c.upload && r !== c.fallback || F(28, a.duration);
                        break;
                    case "longtask":
                        q(7);
                        break;
                    case "first-input":
                        ...
                        break;
                    case "event":
                        e && "PerformanceEventTiming" in window && "interactionId" in PerformanceEventTiming.prototype && (Nu(a), ro(37, _u().toString()));
                        break;
                    case "layout-shift":
    ...
    function Pu(t) {
        return Du || (Du = document.createElement("a")), Du.href = t, Du.host
    }
    var Ru = [hu, pu, mn, Object.freeze({
        __proto__: null,
        start: function() {
            gu(),
                function() {
                    navigator && navigator.connection && ro(27, navigator.connection.effectiveType), window.PerformanceObserver && PerformanceObserver.supportedEntryTypes ? "complete" !== document.readyState ? Jo(window, "load", V.bind(this, Iu, 0)) : Iu() : Oi(3, 0)
                }()
        },
        stop: function() {
            yu && yu.disconnect(), yu = null, Mu(), Du = null, gu()
        }
    }), ri];
        ...
        void 0 === t && (t = null),
            function() {
                try {
                    ...
                    return !1 === cu && "undefined" != typeof Promise && window.MutationObserver && document.createTreeWalker && "now" in Date && "now" in performance && "undefined" != typeof WeakMap && !t
                } catch (t) {
                    return !1
                }
            }() && (! function(t) {
                if (null === t || cu) return !1;
                for (var e in t) e in c && (c[e] = t[e])
            }(t), su(), qt(), Ru.forEach((function(t) {
                return Bo(t.start)()
            })), null === t && zu())
    }

    function ju() {
        du() && (Ru.slice().reverse().forEach((function(t) {
            return Bo(t.stop)()
        })), Ut(), lu(), void 0 !== Xu && (Xu[Lu] = function() {
            (Xu[Lu].q = Xu[Lu].q || []).push(arguments), "start" === arguments[0] && Xu[Lu].q.unshift(Xu[Lu].q.pop()) && zu()
        }))
    }
    var Au = Object.freeze({
            ...
            metadata: Mo,
            pause: function() {
                du() && (L("clarity", "pause"), null === Ni && (Ni = new Promise((function(t) {
                    xi = t
                }))))
            },
            queue: di,
            register: Zr,
            resume: function() {
                du() && (Ni && (xi(), Ni = null, null === Mi && Di()), L("clarity", "resume"))
            },
            schedule: Ci,
            set: dt,
            signal: function(t) {
    ...
    function zu() {
        if (void 0 !== Xu) {
            if (Xu[Lu] && Xu[Lu].v) return console.warn("Error CL001: Multiple Clarity tags detected.");
            var t = Xu[Lu] && Xu[Lu].q || [];
            for (Xu[Lu] = function(t) {
                    for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
                    return Au[t].apply(Au, e)
                }, Xu[Lu].v = h; t.length > 0;) Xu[Lu].apply(Xu, t.shift())
        }
    }
    zu()
}();