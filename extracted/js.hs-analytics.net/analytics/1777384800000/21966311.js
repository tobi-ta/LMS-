 ...
 */
var _hsq = _hsq || [];
_hsq.push(['setPortalId', 21966311]);
_hsq.push(['trackPageView']);
_hsq.push(['setLegacy', false]);
_hsq.push(['addHashedCookieDomain', '233546881']);
_hsq.push(['addHashedCookieDomain', '224894981']);
_hsq.push(['addHashedCookieDomain', '20361767']);
_hsq.push(['addHashedCookieDomain', '20629287']);
_hsq.push(['addHashedCookieDomain', '251652889']);
_hsq.push(['addHashedCookieDomain', '120304535']);
_hsq.push(['addHashedCookieDomain', '142899242']);
_hsq.push(['addHashedCookieDomain', '12033963']);
_hsq.push(['embedHubSpotScript', 'https://js-na1.hs-scripts.com/21966311.js', 'hs-script-loader']);
                ...
                handler: function(t) {
                    try {
                        if (hstc.utils.isDefined(i.portalId)) {
                            ...
                            if (hstc.utils.startsWith(e, "pe" + i.portalId + "_")) i.trackCustomBehavioralEvent({
                                name: e,
                                properties: o
                            });
                        ...
                        hstc.utils.isDefined(i.portalId) && (hstc.utils.startsWith(e, "pe" + i.portalId + "_") || hstc.utils.startsWith(e, "autocaptureClick")) || i.trackEvent(e, n)
                    } catch (t) {
    ...
    ! function(t) {
        ...
        l = it.setDocument = function(t) {
            ...
            E = d.compareDocumentPosition ? function(t, i) {
                ...
                return r ? 1 & r || !n.sortDetached && i.compareDocumentPosition(t) === r ? t === e || y(v, t) ? -1 : i === e || y(v, i) ? 1 : u ? P.call(u, t) - P.call(u, i) : 0 : 4 & r ? -1 : 1 : t.compareDocumentPosition ? -1 : 1
            } : function(t, n) {
                var i, r = 0,
                    o = t.parentNode,
                    s = n.parentNode,
                ...
                if (!o || !s) return t === e ? -1 : n === e ? 1 : o ? -1 : s ? 1 : u ? P.call(u, t) - P.call(u, n) : 0;
        ...
        r = it.selectors = {
            ...
            filter: {
                ...
                CLASS: function(t) {
                    var e = _[t + " "];
                    return e || (e = new RegExp("(^|" + V + ")" + t + "(" + V + "|$)")) && _(t, (function(t) {
                ...
                PSEUDO: function(t, e) {
                    ...
                    if (i.length > 1) {
                        ...
                        return r.setFilters.hasOwnProperty(t.toLowerCase()) ? ot((function(t, n) {
                            for (var r, o = i(t, e), s = o.length; s--;) t[r = P.call(t, o[s])] = !(n[r] = o[s])
                        })) : function(t) {
                            return i(t, 0, n)
                        }
                    }
            ...
            return ot((function(o, s, a, c) {
                ...
                if (o) {
                    if (r || t) {
                        ...
                        l = y.length;
                        for (; l--;)(h = y[l]) && (u = r ? P.call(o, h) : d[l]) > -1 && (o[u] = !(s[u] = h))
                    }
                } else {
                ...
                if (n = r.relative[t[u].type]) d = [gt(mt(d), n)];
                    ...
                    if ((n = r.filter[t[u].type].apply(null, t[u].matches))[k]) {
                        ...
                        return kt(u > 1 && mt(d), u > 1 && pt(t.slice(0, u - 1).concat({
                            value: " " === t[u - 2].type ? "*" : ""
                        })).replace(U, "$1"), n, u < i && vt(t.slice(u, i)), i < o && vt(t = t.slice(i)), i < o && pt(t))
                    }
                    d.push(n)
                }
            return mt(d)
    ...
    ! function(t, e, n) {
        ...
        var t = function(t) {
            ...
            function F() {
                const t = window,
                    e = navigator;
                return p(["msWriteProfilerMark" in t, "MSStream" in t, "msLaunchUri" in e, "msSaveBlob" in e]) >= 3 && !W()
            }
            ...
            function Le(t, e = 4e3) {
                return at(((n, i) => {
                    ...
                    H() ? o.style.zoom = "" + 1 / i.devicePixelRatio : j() && (o.style.zoom = "reset");
            ...
            const Pe = -1,
                ...
                He = ["LOW_FLOAT", "MEDIUM_FLOAT", "HIGH_FLOAT", "LOW_INT", "MEDIUM_INT", "HIGH_INT"],
